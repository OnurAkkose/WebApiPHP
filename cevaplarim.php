...
<?php
	...
	$sorular = $VeritabaniBaglantisi->prepare("SELECT * FROM cevaplar WHERE UyeId= $KullaniciID");
	$sorular->execute();
	   ...
	   <p class="konu">
     	...
     	<div style="height: 100%; width: 50px; float: left; background-color: #A0A0A0;">&nbsp;</div>
	   	<div  style="height: 100%; width: 450px; float: left; background-color: #A0A0A0;">
			...
			<a href="index.php?SK=25&ID=<?php echo  DonusumleriGeriDondur($s["SoruId"]);?>"</a><button class="btn btn-primary buton" >İncele</button></a>
